...
<head>
    ...
    <link rel="stylesheet" href="style_edite.css">
    ...
    <div id="add" class="modal">
        ...
        <form class="modal-content animate" method="POST" action="../../helpers/save_edite_cliente.php">
            ...
            <div class="container1">
                ...
                <div class="man">
                    <input type="text" oninput="validarCnpjCpf(this)" placeholder="CNPJ/CPF" value="<?php echo $cnpj_cpf ?>" name="cnpj_cpf">
                    <input type="text" oninput="semString(this)" placeholder="Inscrição estadual" value="<?php echo $insc ?>" name="inscrição_estadual">
                    ...
                    <input type="text" oninput="semString(this)" placeholder="CEP" value="<?php echo $cep ?>" name="cep">
                    <input type="text" placeholder="Bairro" value="<?php echo $bairro ?>" name="bairro">
                    <input type="text" oninput="semString(this)" placeholder="Número" value="<?php echo $numero ?>" name="numero">
                    <input type="text" placeholder="Cidade" value="<?php echo $cidade ?>" name="cidade">
                    <input type="text" onblur="isEmailValida(this)" placeholder="E-mail" value="<?php echo $email ?>" name="email">
                    <input type="text" oninput="isCelular(event,this)" placeholder="Celular" name="celular" value="<?php echo $celular ?>" required>
